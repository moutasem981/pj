      ...
      <div className='w-full max-w-230 bg-background rounded-3xl overflow-hidden shadow-[0_35px_35px_rgba(0,0,0,0.25)] flex'>
        ...
        <div className='w-full md:w-[52%] md:p-14 sm:p-10 p-6 flex flex-col justify-center'>
          ...
          <div className='mb-9'>
            ...
            <span className='text-primary-bg text-[12px] font-semibold tracking-[2px]'> {t('WELCOME BACK')} </span>

            <h1 className='text-secondary text-[35px] font-bold mt-2'> {t('Sign In')}</h1>

            <p className='text-main text-[13px] mt-2'> {t('Enter your account details to continue shopping.')} </p>
          ...
          <form onSubmit={handleSubmit((data) => {
            Login(data, {
              onError: (error) => {
                setserverErrors([t("Email or password is incorrect")]);
              }
            });
          })}>
            ...
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <Link to='/ForgotPassword' className='text-primary-bg text-[11px] hover:underline'  >  {t('Forgot your password?')} </Link>
          ...
          <div className='text-center mt-7 text-[13px]'>

            <span className='text-main'> {t("Don't have an account?")}</span>

            <Link to='/Register' className='text-primary-bg font-semibold ms-2 hover:underline' > {t('Sign Up')} </Link>
