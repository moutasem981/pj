                    ...
                    <div className='px-3 pt-10 w-full md:w-6/10'>
                        <form className='grid grid-cols-2 gap-x-7 gap-y-11 lg:pe-23 ' >
                            <div className='flex flex-col text-primary-bg '>
                                <label className='text-[14px] ' htmlFor="FirstName">{t('First Name')}</label>
                                <input type="text" className='border-b-2 border-primary-bg focus:outline-none ' />
                            </div>
                            <div className='flex flex-col text-primary-bg'>
                                <label className='text-[14px] ' htmlFor="FirstName">{t('Last Name')}</label>
                                <input type="text" className='border-b-2 border-primary-bg focus:outline-none' />
                            </div>
                            <div className='flex flex-col text-primary-bg'>
                                <label className='text-[14px] ' htmlFor="FirstName">{t('Email')}</label>
                                <input type="text" className='border-b-2 border-primary-bg focus:outline-none' />
                            </div>
                            <div className='flex flex-col text-primary-bg'>
                                <label className='text-[14px] ' htmlFor="FirstName">{t('Phone Number')}</label>
                                <input type="text" className='border-b-2 border-primary-bg focus:outline-none' />
                            </div>
                            <div className='flex flex-col text-primary-bg col-span-2 '>
                                <label className='text-[14px] ' htmlFor="FirstName">{t('Select Subject?')}</label>
                                <div className='flex gap-3.5 mt-3.5'>
                                    <div className='flex gap-2.5'>
                                        <input type="radio" name="" id="GeneralInquiry" />
                                        <label htmlFor="GeneralInquiry" className='text-[12px]'>{t('Order Status')}</label>
                                    </div>
                                    <div className='flex gap-2.5'>
                                        <input type="radio" name="" id="GeneralInquiry" />
                                        <label htmlFor="GeneralInquiry" className='text-[12px]'>{t('Product Inquiries')}</label>
                                    </div>
                                    <div className='flex gap-2.5'>
                                        <input type="radio" name="" id="GeneralInquiry" />
                                        <label htmlFor="GeneralInquiry" className='text-[12px]'>{t('Billing Issues')}</label>
                                    </div>
                                    <div className='flex gap-2.5 items-center'>
                                        <input type="radio" name="" id="GeneralInquiry" />
                                        <label htmlFor="GeneralInquiry" className='text-[12px]'>{t('Other')}</label>
                                    </div>
                                </div>

                            </div>
                            <div className='flex flex-col text-primary-bg col-span-2 '>
                                <label className='text-[14px] ' htmlFor="FirstName">{t('Message')}</label>
                                <input type="text" placeholder={t('Write your message..')} className='border-b-2 border-primary-bg focus:outline-none text-[14px]' />
                            </div>
